...
const Section = () => {
  return (
    <div className="h-[30rem] mb-10 md:mb-0 md:h-screen flex flex-col gap-10 px-3 md:gap-20 items-center justify-center text-center mt-40 lg:mt-0">
        <h1 className="text-5xl font-montserrat font-extrabold md:text-7xl ">Skip the <span className="bg-clip-text text-transparent bg-[radial-gradient(circle_at_top_left,_#10b981,_#84cc16,_#14b8a6)]  bg-[length:200%_200%] animate-gradient-move">Boring</span>, Keep the Story</h1>
